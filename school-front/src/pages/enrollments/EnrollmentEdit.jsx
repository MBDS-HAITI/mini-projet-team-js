...
export default function EnrollmentEdit() {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      try {
        ...
        setForm({
          studentId: en.student?._id || en.studentId || "",
          courseId: en.course?._id || en.courseId || "",
          anneeAcademique: en.anneeAcademique || "2025-2026",
          statut: en.statut || "VALIDE",
          dateInscription: en.dateInscription
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await api.put(`/api/enrollments/${id}`, {
